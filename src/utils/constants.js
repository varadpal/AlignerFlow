...
/** Achievement definitions (icon = name in the Icon component) */
...
/** Note tag definitions (icon = name in the Icon component) */
export const NOTE_TAGS = [
  { id: 'dental', label: 'Dental Visit', icon: 'calendar' },
  { id: 'discomfort', label: 'Discomfort', icon: 'frown' },
  { id: 'switch', label: 'Tray Switch', icon: 'refresh' },
  { id: 'milestone', label: 'Milestone', icon: 'flag' },
  { id: 'general', label: 'General Note', icon: 'file-text' }
];
