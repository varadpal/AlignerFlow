...
/**
 * SkyToggle — A beautiful day/night theme switch.
 * Usage: <SkyToggle checked={isDark} onChange={setIsDark} />
 *
 * Props:
 *   checked  (bool)     — controlled state; true = night/dark
 *   onChange (function) — callback receives new boolean value
 */
export default function SkyToggle({ checked = false, onChange }) {
  return (
    <StyledWrapper>
